...
It is unlikely that anything will go wrong, but if you feel it has, please contact Tuomas Eerola tuomas.eerola@durham.ac.uk

What if I change my mind during the study or after the study is complete?
You can stop at any point during the study by closing the browser window. If, having completed the study, you change your mind and wish to withdraw your data, simply email the researchers using the email address tuomas.eerola@durham.ac.uk. All data provided will be anonymised, they will not be available to anyone outside the researchers listed above and cannot be traced back to your identity. All data published will be entirely anonymous and unidentifiable. The responsibility for this survey rests entirely with the researchers listed above. 
